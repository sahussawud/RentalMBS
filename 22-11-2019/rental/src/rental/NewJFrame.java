...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel7.setBackground(new java.awt.Color(249, 243, 161));
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(Edit_cs, javax.swing.GroupLayout.DEFAULT_SIZE, 146, Short.MAX_VALUE)
                        .addComponent(Delete_cs, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                                    ...
                                    .addGroup(rentLayout.createSequentialGroup()
                                        .addGroup(rentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(rentLayout.createSequentialGroup()
                                                ...
                                                .addGap(18, 18, 18)
                                                .addComponent(fee, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                                            ...
                                            .addGroup(rentLayout.createSequentialGroup()
                                                ...
                                                .addGroup(rentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    .addGroup(rentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                        ...
                                                        .addComponent(cusid))
                                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, rentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(rentLayout.createSequentialGroup()
                                                .addGroup(rentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    ...
                                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, rentLayout.createSequentialGroup()
                                                        ...
                                                        .addGap(18, 18, 18)))
                                                .addGroup(rentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    .addComponent(mud, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel78.setForeground(new java.awt.Color(102, 102, 0));
        jLabel78.setText("Check");
        ...
        jLabel79.setFont(new java.awt.Font("Trebuchet MS", 1, 48)); // NOI18N
        jLabel79.setForeground(new java.awt.Color(153, 153, 255));
        jLabel79.setText("Summary");
        jPanel12.add(jLabel79);

        jLabel80.setForeground(new java.awt.Color(153, 153, 255));
        jLabel80.setText("welcome back mr.sahussawud");
        ...
        jTabbedPane2.addTab("จักรยานยนต์ทั้งหมด", jPanel10);
        ...
        jTabbedPane2.addTab("ธุรกรรมล่าสุด", jPanel14);
        ...
        jPanel15Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel15Layout.createSequentialGroup()
                .addGap(43, 43, 43)
                .addComponent(jScrollPane11, javax.swing.GroupLayout.PREFERRED_SIZE, 1051, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTabbedPane2.addTab("รายการตรวจสอบ", jPanel15);
        ...
        jLabel82.setFont(new java.awt.Font("Leelawadee UI", 2, 36)); // NOI18N
        ...
        jPanel18.add(available_p3);

        available_p1.setBackground(new java.awt.Color(204, 255, 204));

        jLabel86.setFont(new java.awt.Font("Century Gothic", 1, 36)); // NOI18N
        jLabel86.setForeground(new java.awt.Color(51, 153, 0));
        jLabel86.setText("ยอดขายทั้งหมด");
...
//                    jDateChooser1.setDate(d);
    ...
    private void jPanel4MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseEntered
        // TODO add your handling code here:
        jPanel4.setBackground(new java.awt.Color(255, 127, 157));
 ...
 Connection con;
    ...
    public void table_update4() {
        ...
        try {
            ...
            int r = jTable1.getRowCount(), avai = 0, no_avai = 0;

            int row_check = jTable3.getRowCount();

            for (int i = 0; i < r; i++) {
                Object obj1 = GetData(jTable1, i, 5);
                if (obj1.equals("ว่าง")) {
                    avai++;
    ...
    public void update() {
        ...
        if (whole_sale - cost < 0) {
            ...
            available_p1.setBackground(java.awt.Color.red);
        } else {
            jLabel17.setText("กำไร");
            jLabel17.setForeground(java.awt.Color.black);
            label2.setBackground(java.awt.Color.green);
            available_p1.setBackground(java.awt.Color.green);
        }
        label3.setText(jTable2.getRowCount() + "");
    ...
    public Object[][] jtable2_getdata() {
        ...
        for (int i = 0; i < row; i++) {
            Object date = GetData(jTable2, i, 0);
            data[i][0] = date.toString();
            double mon = Double.parseDouble(GetData(jTable2, i, 3).toString());
            data[i][1] = mon;
            data[i][2] = GetData(jTable2, i, 2).toString();
            data[i][3] = GetData(jTable2, i, 1).toString();
        }
    ...
    public Object[][] jtable2_noti() {
        ...
        for (int i = 0; i < row; i++) {
            data[i][0] = GetData(jTable2, i, 0).toString();
            data[i][1] = GetData(jTable2, i, 1).toString();
            data[i][2] = GetData(jTable2, i, 2).toString();
            data[i][3] = GetData(jTable2, i, 3).toString();
            data[i][4] = GetData(jTable2, i, 4).toString();
        }
    ...
    private DefaultCategoryDataset createDataset(Object[][] data, int len, int m, String y) {
     ...
     private void lineCreate() {
        ...
        JFreeChart lineChart = ChartFactory.createLineChart3D(
                ...
                "date", "Amount(บาท)",
                createDataset(jtable2_getdata(), jTable2.getRowCount(), month, year),
...
// sets paint color for each series
        plot.getRenderer().setSeriesPaint(0, java.awt.Color.GREEN);
        plot.getRenderer().setSeriesPaint(1, java.awt.Color.RED);

        plot.setBackgroundPaint(java.awt.Color.YELLOW);
...
// sets thickness for series (using strokes)
    ...
    private void PieChart() {
        ...
        plot.setBackgroundPaint(java.awt.Color.PINK);
