...
public class Dashboard{
    ...
    private Label expense,revenue,whole_sale,amount_transaction;
    ...
    public Dashboard(JTable dashboard, JTable dashboard2,JTable dashboard3,JList jList1, JPanel Pnpanel) throws ClassNotFoundException, SQLException, ParseException {
        
        d = new Database();
        
        this.DashboardTB = d.getDashboardTB(dashboard);
        this.TransTB = d.getTransTB(dashboard2);
        this.CheckTB = d.getCheckTB(dashboard3);
        this.notification = jList1;
        this.Available = new JLabel();
        this.Busy = new JLabel();
        this.Check = new JLabel();
        this.pnChart = Pnpanel;
...
//        this.revenue = revenue;
    ...
    public void setWhole_sale(Label whole_sale) {
        this.whole_sale = whole_sale;
    }
    ...
    public void setRevenue(Label revenue) {
        this.revenue = revenue;
    }
    ...
    public Label getAmount_transaction() {
        return amount_transaction;
    }

    public void setAmount_transaction(Label amount_transaction) {
        this.amount_transaction = amount_transaction;
    }
    ...
    public void setExpense(Label expense) {
        this.expense = expense;
    }
    ...
    public void updateStatus(){
        ...
        int r = DashboardTB.getRowCount(), avai = 0, no_avai = 0, row_checkTB = 0;
        row_checkTB = CheckTB.getRowCount();
            ...
            for (int i = 0; i < r; i++) {
                ...
                if (obj1.equals("ว่าง")) {
                    ...
                    no_avai++;
                    System.out.println(row_checkTB);
                } else if(obj1.equals(null)){
            ...
            this.Available.setText(avai + "");
            this.Busy.setText(no_avai + "");
            this.Check.setText(row_checkTB + "");
            System.out.println("888888888888");
    }
