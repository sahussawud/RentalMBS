...
public class Expense extends javax.swing.JFrame {
                ...
                .addGroup(Summary1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(Summary1Layout.createSequentialGroup()
                        ...
                        .addGroup(Summary1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(IDexpense, javax.swing.GroupLayout.DEFAULT_SIZE, 136, Short.MAX_VALUE)
                ...
                .addGroup(Summary1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, Summary1Layout.createSequentialGroup()
                        .addGroup(Summary1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, Summary1Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jDateChooser1.setDate((Date)d1.getValueAt(selectedrow, 1));
...
//    public ArrayList<Expense_s> ExpenseList() {
//        ArrayList<Expense_s> ExpenseList = new ArrayList<>();
//        String sql = "select * from ExpenseTB";
//        try {
//            Connection c = connectDB();
//            String query1 = "SELECT * FROM ExpenseTB";
//            Statement st = c.createStatement();
//            ResultSet rs = st.executeQuery(query1);
//            Expense_s expense;
//            while (rs.next()) {
//                expense = new Expense_s(rs.getInt("amount_expense"), rs.getString("id_expense"), rs.getString("type_expense"), rs.getString("reciver_expense"), rs.getString("detail_expense"), rs.getDate("date_expense"));
//            }
//
//        } catch (Exception e) {
//            e.printStackTrace();
